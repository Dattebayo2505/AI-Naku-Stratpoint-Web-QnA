...
Instructions:
1. First, perform a grounding check inside the "reasoning" field. Outline the facts needed to answer and verify if they exist in the context.
2. In the "answer" field, formulate your response using ONLY facts explicitly stated in the context.
...
Instructions:
1. Provide a grounded answer to the user's question using ONLY facts explicitly mentioned in the context.
...
2. In the "answer" field, write your grounded response. Do not use outside information or make assumptions.
